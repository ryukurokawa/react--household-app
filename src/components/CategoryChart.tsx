...
const categoryLabel = Object.keys(categorySums) as (IncomeCategory | ExpenseCategory)[]
const categoryValue = Object.values(categorySums)
...
const getCategoryColor = (category:IncomeCategory | ExpenseCategory):string => {
 ...
 const data:ChartData<"pie"> = {
    ...
    datasets: [
      {
        data: categoryValue,
        backgroundColor:categoryLabel.map((category) => getCategoryColor(category)),
        borderColor:categoryLabel.map((category) => getCategoryColor(category)),
        borderWidth: 1,
      },
    ],
  };
